...
// File: contracts\TridentToken.sol

pragma solidity 0.6.12;


// TridentToken with Governance.
contract TridentToken is BEP20('Trident Token', 'TRDNT') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "TRIDENT::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "TRIDENT::delegateBySig: invalid nonce");
        require(now <= expiry, "TRIDENT::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "TRIDENT::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying TRDNTs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "TRIDENT::_writeCheckpoint: block number exceeds 32 bits");
